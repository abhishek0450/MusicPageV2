...
const Player = () => {
  ...
  const [hasSetInitialTime, setHasSetInitialTime] = useState<boolean>(false);
  ...
  useEffect(() => {
    ...
    const handleLoadedMetaData = () => {
      ...
      if (currentTime > 0 && !hasSetInitialTime) {
  ...
  }, [song, currentTime, hasSetInitialTime, setCurrentTime]);
